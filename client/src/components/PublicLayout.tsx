    ...
    <div style={{ minHeight: "100vh", background: "var(--preto)", display: "flex", flexDirection: "column" }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 32 }}>
          ...
          {/* Logo */}
          <Link href="/">
            <img src="/logo-pnsp.jpg" alt="PNSP" title="PNSP - Plataforma Nacional do Samba e Pagode" style={{ height: 80, width: "auto", cursor: "pointer", display: "block", filter: "invert(1) brightness(1.2)" }} />
          </Link>
